...
PICKLE_DIR = "C:/Users/Deepak L/Music/Distracted-Driver-Detection-master/pickle_files"
JSON_DIR = os.path.join(os.getcwd(),"json_files")

if not os.path.exists(JSON_DIR):
    os.makedirs(JSON_DIR)

BEST_MODEL = "C:/Users/Deepak L/Music/Distracted-Driver-Detection-master/model/self_trained/distracted-21-1.00.hdf5"
